(() => {
    ...
    function projectRecordForActiveAudit(record) {
        if (!state.activeAudit || state.activeAudit.isNew) return record;
    ...
    // El % ocupa el lugar de la vieja X: quitar el defecto ya se hace desde el
    // selector ("Quitar defecto"), y dos X seguidas se confundian con la de la
        ...
        return `
            <div class="rollo-defecto-row" data-defecto-index="${defectoIndex}">
                ...
                <button
                    ...
                    title="Medir en porcentaje">%</button>
            </div>
        `;
    }
        ...
        return `
            <div class="rollo-card" data-rollo-index="${rolloIndex}">
                <div class="rollo-card-head">
                    ...
                    ${buildRolloFieldHtml('densidad', 'Dens', card.densidad, true, false)}
